...
"[project]/app/api/v1/transactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const transactions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$models$2f$Transaction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Transaction"].find({
            user: user.id
        }).sort({
            createdAt: -1
        });
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])("Server error while fetching transactions.");
    }
}
async function POST(request) {
    try {
        ...
        if (!text || amount === undefined) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])("Text and amount are required.", 400);
        }
        ...
        if (createdAt !== undefined && createdAt !== null && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValidDate"])(createdAt)) {
        ...
        const transaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$models$2f$Transaction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Transaction"].create({
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])("Server error while creating transaction.");
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a1xhg0._.js.map