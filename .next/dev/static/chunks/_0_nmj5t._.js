...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            try {
                const storedToken = localStorage.getItem("kharcha_token");
                const storedUser = localStorage.getItem("kharcha_user");
    ...
    const login = async (email, password)=>{
        ...
        localStorage.setItem("kharcha_token", loggedInToken);
        localStorage.setItem("kharcha_user", JSON.stringify(loggedInUser));
    ...
    const register = async (name, email, password)=>{
        ...
        localStorage.setItem("kharcha_token", registeredToken);
        localStorage.setItem("kharcha_user", JSON.stringify(registeredUser));
...
//# sourceMappingURL=_0_nmj5t._.js.map